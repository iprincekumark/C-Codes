/*
Write c program to create a singly linked list , then in another function input a key ,search that key 
if found delete that node from the linked list. Finally display the linked list. 
(Use separate function for inserting node, deleting node and to display the list)
*/
#include <stdio.h>
#include <malloc.h>
typedef struct node
